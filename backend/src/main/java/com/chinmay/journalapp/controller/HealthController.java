...
import com.chinmay.journalapp.dto.UserDTO;
import com.chinmay.journalapp.entity.UserAccount;
import com.chinmay.journalapp.service.AuthUserDetailsService;
import com.chinmay.journalapp.service.AccountService;
import com.chinmay.journalapp.utilis.JwtUtil;
...
/**
 * Controller handling public authentication, signup, and system health checking.
 * I developed these endpoints to manage authentication and token generation.
 */
@RestController
...
public class HealthController {
    ...
    @Autowired
    private com.chinmay.journalapp.repository.AccountRepository accountRepository;

    @Autowired
    private JwtUtil jwtUtil;

    @Autowired
    private com.chinmay.journalapp.service.RefreshTokenService refreshTokenService;

    @Autowired
    private com.chinmay.journalapp.service.FirebaseAuthService firebaseAuthService;

    /**
     * System health check route.
     * I added this to verify service availability quickly.
     *
     * @return ok message
     */
    ...
    /**
     * Exchanges Firebase ID Token for local application JWT session cookies.
     * I implemented this to enable secure federated authentication.
     *
     * @param request body containing idToken
     * @param response servlet response for injecting HTTP-only cookies
     * @return Local token and username
     */
    ...
    public ResponseEntity<?> firebaseLogin(@RequestBody java.util.Map<String, String> request, jakarta.servlet.http.HttpServletResponse response) {
        try {
            ...
            com.chinmay.journalapp.entity.RefreshToken refreshToken = refreshTokenService.createRefreshToken(user.getUserName());
     ...
     * I created this to normalize inputs, verify uniqueness, and assign defaults.
     *
     * @param user user credentials DTO
     * @return the saved UserAccount record
     */
    @PostMapping("/signup")
    ...
    /**
     * Generates a new access token using valid refresh tokens.
     * I designed this to maintain persistent client sessions securely.
     *
     * @param request servlet request containing cookies
    ...
    /**
     * Clears active refresh tokens and logs out user session.
     * I implemented this to invalidate tokens actively.
     *
